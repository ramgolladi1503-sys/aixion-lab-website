...
export const systems: SystemRecord[] = [
  ...
  },
  {
    ...
    descriptor: "Workflow, QA, and operational automation built around traceability and failure handling.",
  ...
  },
  {
    ...
    descriptor: "Decision-support experiments across analytics, data quality, and operational visibility.",
