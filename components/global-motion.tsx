...
const PAGE_SPECS: Array<{ match: (path: string) => boolean; specs: MotionSpec[] }> = [
  ...
  { match:p=>p.startsWith("/systems/")&&p!=="/systems", specs:[
    {selector:".showcase-identity",variant:"headline"},{selector:".showcase-context",variant:"copy"},{selector:".showcase-hero-media",variant:"image"},{selector:".showcase-capability-strip > article",variant:"card",stagger:90},{selector:".showcase-subnav",variant:"rail"},{selector:".showcase-active-panel",variant:"section"},
  ]},
];
