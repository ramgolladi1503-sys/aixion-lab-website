...
export const metadata: Metadata = {
  ...
  category: "technology",
  keywords: ["Aixion Lab", "Aixion Lab by Ram", "evidence-led systems engineering", "quality engineering", "automation", "software engineering", "applied AI", "agent governance", "real-time systems", "evidence-led engineering"],
...
const structuredData = {
  ...
  "@graph": [
    ...
    { "@type": "ProfilePage", "@id": `${siteUrl}/about/#profile`, url: `${siteUrl}/about`, name: "About Ram — Aixion Lab", isPartOf: { "@id": `${siteUrl}/#website` }, mainEntity: { "@id": `${siteUrl}/#ram` } },
  ],
};
